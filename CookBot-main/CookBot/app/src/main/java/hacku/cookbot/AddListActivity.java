...
public class AddListActivity<savedInstanceState> extends AppCompatActivity {
    // データ格納用のList
    ...
    protected void onStart() {
        ...
        Button sendButton = findViewById(R.id.button01);
    ...
    public void onAddItem(View view) {
        ...
        System.out.println("(main)nameList.size()="+nameList.size());
        System.out.println("(main)dateList.size()="+dateList.size());
        System.out.println("(main)adapter.getItemCount()+1="+(adapter.getItemCount()+1));
    }
